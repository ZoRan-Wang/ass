...
-   [reactable](https://glin.github.io/reactable/) provides functions to create interactive data tables for R, based on the [React Table](https://github.com/TanStack/table) library and made with [reactR](https://github.com/react-R/reactR).
...
In the code chunk below, `odbcConnectAccess()` of [RODBC](https://cran.r-project.org/package=RODBC) package is used used to import a database query table into R.
